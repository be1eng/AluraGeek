...
async function agregarProducto(nombre, imagen, precio) {
  try {
    ...
    // opcional: limpiar los campos después de unos segundos
    setTimeout(() => {
      limpiarCamposFormulario();
    }, 2000); // limpiar después de 2 segundos (ejemplo)
...
function limpiarCamposFormulario() {
  formulario.reset(); // resetear el formulario (limpia todos los campos)
  parrafoNombre.innerText = "";
  parrafoImagen.innerText = "";
  parrafoPrecio.innerText = "";
...
// limpiar los párrafos y resetear los campos al hacer clic en el botón Limpiar
